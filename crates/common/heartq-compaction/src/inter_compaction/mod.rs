...
//! per-harness; the HeartQ chat host wraps this pipeline.

pub mod compact;
pub mod config;
pub mod enhanced_summary;
pub mod observer;

pub use compact::{ChunkedCompactionOutput, sample_compaction_chunked};
pub use config::InterCompactionConfig;
pub use enhanced_summary::{EnhancedSummaryTemplate, SummaryBuilder, SummarySection};
