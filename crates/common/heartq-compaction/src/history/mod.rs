...
//! string/text manipulation. Harness-bound extraction (HeartQ chat's
//! `HeartQConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `HeartQMessage` assembly) stays in the harness crate.
