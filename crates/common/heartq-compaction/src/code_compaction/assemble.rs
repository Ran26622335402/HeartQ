//! Compacted-history assembly (heartq-build's rebuild structure, generic).
//!
...
//! ```
//!
//! heartq-build is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // heartq-build keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn heartq_build_order_recent_before_summary() {
