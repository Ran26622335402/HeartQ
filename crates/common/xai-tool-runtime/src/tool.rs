...
/// `filename`, `path`, `metadata`) that the HeartQ SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the HeartQ SLOP converter to
    ...
    /// - `path`: file path on the HeartQ Computer filesystem
