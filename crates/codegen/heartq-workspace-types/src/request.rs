...
//!   here would force every consumer of `heartq-workspace-types`
...
//! (`heartq-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `heartq-workspace-types`
