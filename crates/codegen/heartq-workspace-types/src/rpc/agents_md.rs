...
/// Claude.md / `.heartq/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.heartq` and compat dirs.
...
/// Mirrors the serde shape of `heartq-agent`'s `AgentConfigFile`.
