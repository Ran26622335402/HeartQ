...
//! `heartq-workspace`. Wire types live in
//! `heartq_workspace_types::rpc`; this crate adds the connected-state
...
use heartq_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use heartq_workspace_types::rpc::code_nav::{
...
use heartq_workspace_types::rpc::fs::{
...
use heartq_workspace_types::rpc::git::{
...
use heartq_workspace_types::rpc::hunks::{
...
use heartq_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use heartq_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use heartq_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use heartq_workspace_types::rpc::worktree::{
...
use heartq_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
mod tests {
    ...
    use heartq_workspace_types::rpc::skills::SkillScope;
        ...
        async fn run(&self, _ctx: ToolCallContext, args: Self::Args) -> Result<RawOut, ToolError> {
            ...
            match args.method.as_str() {
                ...
                "workspace.discover_skills" => ok(serde_json::json!(
                    ...
                    "path" : "/workspace/.heartq/skills/my-skill/SKILL.md", "scope"
                    : "local", }]
                )),
