...
/// The base prompt template source, exposed for `heartq prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `heartq prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard heartq-build tool kinds.
