...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "heartq-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "heartq-3", "researcher");
    ...
    let shared_models = ["heartq-3", "heartq-3-mini"];
