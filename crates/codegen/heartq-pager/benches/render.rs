//! Criterion benchmarks for the heartq-pager rendering pipeline.
//!
...
use heartq_pager::scrollback::render::render_scrolled_entries_with_scratch;
use heartq_pager::scrollback::wrappers::EntryRenderer;
use heartq_pager::scrollback::{
