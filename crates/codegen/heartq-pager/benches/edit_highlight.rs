...
//!
//! ```text
//! cargo bench -p heartq-pager --bench edit_highlight
//! cargo bench -p heartq-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use heartq_pager::diff::{DiffHunk, DiffLine};
use heartq_pager::scrollback::blocks::tool::{
...
use heartq_pager::syntax::{Syntect, get_syntect};
