...
async fn storage_upload_parks_on_401_and_drains_after_recovery() {
    ...
    env_refs.retain(|(k, _)| *k != "HEARTQ_TRACE_UPLOAD");
    env_refs.push(("HEARTQ_TRACE_UPLOAD", "true"));
    env_refs.push(("HEARTQ_TELEMETRY_TRACE_UPLOAD", "true"));
    env_refs.push(("HEARTQ_UPLOAD_QUEUE_AUTH_PROBE_SECS", "2"));
    ...
    //   not fire inside this 3s window; with `HEARTQ_UPLOAD_QUEUE_AUTH_PROBE_SECS=2`
