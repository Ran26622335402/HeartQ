# HeartQ Build User Guide

Learn how to install, configure, and extend HeartQ Build, the terminal-based AI coding assistant by hypercn.
...
Customize and extend HeartQ Build.
...
Automate, script, and integrate HeartQ Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `heartq -p`, output formats, CI/CD integration, and piping |
