...
Terminal UI (TUI) for HeartQ Build. Provides the interactive full-screen interface
...
- [Hook Examples](../heartq-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`heartq-hooks`)](../heartq-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`heartq-plugin-marketplace`)](../heartq-plugin-marketplace/) — marketplace source loading, scanning, and install
