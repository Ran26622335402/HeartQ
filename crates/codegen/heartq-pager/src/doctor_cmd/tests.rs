...
fn mixed_report() -> DiagnosticReport {
    ...
    report.facts.color = ColorFacts {
        ...
        available_themes: vec![ThemeKind::HeartQNight, ThemeKind::HeartQDay],
        total_themes: ThemeKind::ALL.len(),
    };
    ...
    report.findings = vec![
        ...
        DiagnosticFinding {
            ...
            message: "Use local SSH wrapping".to_owned(),
            remediation: Some(ManualRemediation {
                fix: "heartq wrap ssh <host>".to_owned(),
                config_path: None,
            }),
            automatic_remediation: Some(crate::diagnostics::ssh_wrap_automatic_remediation()),
            note: None,
...
fn human_mixed_fixture_is_exact() {
    assert_eq!(
        ...
        concat!(
            ...
            "  · ssh                          yes\n",
            "  · color                        256\n",
            "  · themes                       2/5: heartqnight, heartqday\n",
            ...
            "    → Automatic setup: `heartq doctor fix ssh-wrap`\n",
            "    → One-off: `heartq wrap ssh <host>`\n",
            "\n",
            "Probe notes\n",
...
fn fix_preview_contains_exact_change_and_caveats() {
    ...
    assert!(
        preview.contains("One-off alternative without changing config: `heartq wrap ssh <host>`")
    );
...
fn json_contract_is_structural_stable_ordered_and_ansi_free() {
        ...
        serde_json::json!({
            ...
            "facts": {
                ...
                "color": {
                    ...
                    "availableThemes": ["heartqnight", "heartqday"],
                    "totalThemes": 5
                },
            ...
            "findings": [
                ...
                },
                {
                    ...
                    "remediation": {"fix": "heartq wrap ssh <host>", "configPath": null},
                    "automaticRemediation": {
                        "fixId": "terminal.ssh-wrap",
                        "command": "heartq doctor fix terminal.ssh-wrap"
                    },
                    "note": null
                }
            ],
    ...
    assert!(!text.contains("HeartQ Doctor"));
}
