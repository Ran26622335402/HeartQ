...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "heartqnight",
        display: "HeartQ Night",
...
const CODING_DATA_SHARING_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        canonical: "opt-in",
        display: "Opt in",
        description: "Allow HeartQ (by HyperAI) to retain local coding session data and surface it across sessions via persistent memory. Sessions stay on-device.",
    },
    EnumChoice {
        canonical: "opt-out",
        display: "Opt out",
        description: "Do not retain coding session data across sessions. In-memory context still works; only the persistent memory layer is disabled.",
    },
];
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain heartq in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain heartq in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `heartq_voice::STT_LANGUAGES` (official HeartQ STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain heartq opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "heartqnight".
                default: "heartqnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "heartqnight".
                default: "heartqnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "heartqday".
                default: "heartqday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "heartq", "switch"],
        ...
        // The `HEARTQ_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Controls whether HeartQ (by HyperAI) may retain and recall coding \
                          session data across sessions via the persistent memory layer. \
        ...
        // follows the process locale when it maps to a HeartQ STT language.
        // Catalog = official STT languages (see heartq_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (HeartQ STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "At session load over SSH, recommend `heartq wrap ssh` for \
