                ...
                if let Err(msg) = self.prompt.insert_image(pasted) {
                    ...
                    if ctx.source.tip_showing() {
                        heartq_telemetry::session_ctx::log_event(
                            heartq_telemetry::events::ContextualTip {
...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question =
            heartq_tools::implementations::heartq_build::ask_user_question::Question {
                question: "Pick one?".to_string(),
                options: vec![
                heartq_tools::implementations::heartq_build::ask_user_question::QuestionOption
