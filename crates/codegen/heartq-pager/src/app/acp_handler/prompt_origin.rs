...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    heartq_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        heartq_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        heartq_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        heartq_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        heartq_shell::session::PromptOrigin::TaskCompleted { .. }
            | heartq_shell::session::PromptOrigin::SubagentCompleted { .. }
            | heartq_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | heartq_shell::session::PromptOrigin::NotificationDrain
    )
}
