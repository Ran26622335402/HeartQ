...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. HeartQNight's dark band leaking into HeartQDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default HeartQNight, dark) after the user switches —
        // painting a dark band on a light HeartQDay canvas.
