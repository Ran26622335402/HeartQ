...
const HERO_SUBTITLE: &str = "红桃Q (HeartQ) — created by HyperAI · feedback: /feedback";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&heartq_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("HeartQ 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("HeartQ 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(heartq_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/heartq".into()),
        ...
        let mut dismissible = ann(None, Some("HeartQ 4.5 is here. Upgrade now."));
        dismissible.cta = Some(heartq_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://x.ai/heartq".into()),
            caption: Some("or use Ctrl+O".into()),
        });
