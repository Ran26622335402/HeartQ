...
use heartq_markdown::StreamingMarkdownRenderer;
pub use heartq_tools::implementations::heartq_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<heartq_telemetry::events::CreditLimitChoice>,
    },
    /// SuperHeartQ upsell modal: the free-usage paywall (429 +
    ...
    /// `id`.
    FreeUsageUpsell {
        /// Telemetry source for `SuperHeartQUpsellClicked` — distinguishes
        /// the paywall from the restricted-command upsell.
        source: heartq_telemetry::events::SuperHeartQUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<heartq_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    /// questions (e.g. the SuperHeartQ upsell) have no freeform row, so
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> heartq_tools::implementations::heartq_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: heartq_tools::implementations::heartq_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    /// `no_freeform` questions (e.g. the SuperHeartQ upsell) have no "Other"
