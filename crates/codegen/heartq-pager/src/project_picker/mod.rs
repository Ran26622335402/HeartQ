...
use heartq_tools::implementations::heartq_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run HeartQ Build in a project directory?\n\n\
                 This gives HeartQ Build full context of your codebase for better results."
                .into(),
            id: None,
            options,
