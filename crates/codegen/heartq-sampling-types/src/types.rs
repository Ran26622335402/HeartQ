...
// Re-export ToolDefinition and FunctionTool from heartq-tools.
...
pub use heartq_tools::types::definition::{FunctionTool, ToolDefinition};
...
mod tests {
    ...
    fn parse_reasoning_efforts_meta_absent_is_none() {
        ...
        assert!(
            parse_reasoning_efforts_meta(Some(json!({ "agentType": "heartq" }).as_object().unwrap()))
                .is_none()
        );
    }
