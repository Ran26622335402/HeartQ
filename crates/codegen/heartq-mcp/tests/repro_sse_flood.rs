...
//!
//! Run with: cargo test -p heartq-mcp --test repro_sse_flood -- --nocapture
...
use heartq_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use heartq_mcp::rmcp::ServiceExt;
use heartq_mcp::rmcp::transport::StreamableHttpClientTransport;
use heartq_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
