...
use heartq_pager::appearance::AppearanceConfig;
use heartq_pager::minimal_api;
use heartq_pager::render::Renderable;
use heartq_pager::scrollback::block::RenderBlock;
use heartq_pager::scrollback::blocks::ToolCallBlock;
use heartq_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            heartq_pager::scrollback::blocks::BtwBlock::new(
                "original question",
                "original answer",
            ),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use heartq_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                heartq_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use heartq_pager::diff::DiffLine;
    ...
    fn commit_display_mode_lookups_collapse_on_success_only() {
        use heartq_pager::scrollback::blocks::{
