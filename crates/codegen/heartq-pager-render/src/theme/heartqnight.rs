//! HeartQNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// HeartQNight palette — neutral gray base + TokyoNight accent colors.
//
