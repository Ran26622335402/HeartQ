//! Installed heartq CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "HEARTQ_TEST_VERSION";

pub const VERSION: &str = match option_env!("HEARTQ_VERSION") {
    Some(v) => v,
