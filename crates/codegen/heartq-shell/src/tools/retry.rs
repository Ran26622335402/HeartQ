//! Retry utilities — re-exported from `heartq-tools`.
//!
//! The canonical implementation now lives in `heartq_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use heartq_tools::retry::BackoffConfig as RetryConfig;
pub use heartq_tools::retry::{BackoffConfig, execute_with_backoff};
