...
pub fn loaded_plugin_to_info(plugin: &heartq_agent::plugins::LoadedPlugin) -> PluginInfo {
    use heartq_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &heartq_agent::plugins::PluginOrigin) -> PluginOrigin {
    use heartq_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectHeartQ => PluginOrigin::ProjectHeartQ,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserHeartQ => PluginOrigin::UserHeartQ,
...
mod tests {
    use super::*;
    use heartq_agent::plugins::PluginOrigin as AgentOrigin;
    use heartq_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> heartq_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        heartq_agent::plugins::LoadedPlugin {
