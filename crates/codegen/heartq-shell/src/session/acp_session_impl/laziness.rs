...
impl SessionActor {
    ...
    /// sees "HeartQ is thinking", streaming token chunks, or any other
    ...
    pub(crate) async fn maybe_fire_laziness_check(self: Arc<Self>) {
        ...
        let request = ConversationRequest {
            ...
            // Don't pass `reasoning_effort` — `heartq-4.5` (and
            // other tool-flavoured HeartQ variants) reject the field at
            ...
            x_heartq_session_id: Some(session_id_str),
