...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<heartq_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(heartq_tools::implementations::heartq_build::update_goal::UpdateGoalInput),
    Channel(heartq_tools::implementations::heartq_build::update_goal::UpdateGoalEnvelope),
}
