...
impl SessionActor {
        ...
        *self.current_prompt_mode.lock() = prompt_mode;
        ...
        if mode.is_plan() {
            ...
            heartq_telemetry::session_ctx::log_event(
                heartq_telemetry::events::PlanModeToggled {
                    enabled: true,
                    trigger: heartq_telemetry::events::PlanModeTrigger::User,
                    turn_in_flight,
    ...
    /// first-entry/reentry distinction), or heartq's reentry/full variant.
