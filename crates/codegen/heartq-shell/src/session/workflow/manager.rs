...
impl WorkflowManager {
    ...
    fn cancel_children_for_run(&self, run_id: &str) -> bool {
        ...
        self.subagent_event_tx
            .send(
                heartq_tools::implementations::heartq_build::task::types::SubagentEvent::Cancel(
                    heartq_tools::implementations::heartq_build::task::types::SubagentCancelRequest {
                        target: heartq_tools::implementations::heartq_build::task::types::SubagentCancelTarget::WorkflowRunId(
                            run_id.to_owned(),
                        ),
                        respond_to,
                    },
...
mod tests {
    ...
    type CancelLog = Arc<
        parking_lot::Mutex<
            Vec<heartq_tools::implementations::heartq_build::task::types::SubagentCancelTarget>,
        >,
    >;
    ...
    async fn pause_marks_user_paused_and_resume_replays() {
        ...
        use heartq_tools::implementations::heartq_build::task::types::SubagentEvent;
        ...
        use heartq_tools::implementations::heartq_build::task::types::SubagentResult;
    ...
    async fn workflow_spawns_await_to_completion() {
        ...
        assert_eq!(
            ...
            heartq_tools::implementations::heartq_build::task::types::ModelOverrideProvenance::Tool,
