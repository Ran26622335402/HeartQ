//! Memory system shim.
//!
//! The memory "core engine" now lives in the standalone `heartq-memory`
...
pub use heartq_memory::{
    ...
    // Phase 1: memory prefetch + turn sync.
    prefetch::{MemoryBlock, MemoryPrefetch, MemorySource, PrefetchResult},
    sync::{Insight, InsightSource, TurnSync, NoOpTurnSync, RuleBasedInsightExtractor, StorageTurnSync},
    // Phase E: learning graph.
    learning::{LearningGraph, LearningGraphBuilder, LearningGraphInputs},
};
