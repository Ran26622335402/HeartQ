...
//!
//! The official `heartq-agent-sdk` lets a host define in-process tools (`@tool` /
...
use heartq_mcp::acp_transport::AcpReverseInvoker;
use heartq_mcp::servers::AcpServerEntry;
use heartq_mcp::wire;
