...
//! other concurrently running heartq processes (which may wipe or downgrade
...
/// User-configurable overrides via `~/.heartq/settings.json` are deferred
/// to a follow-up.
...
///
/// TODO: When multiple heartq processes run concurrently, they each have
