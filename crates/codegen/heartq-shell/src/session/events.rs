...
) -> Option<heartq_sampling_types::PriorTurnInterrupt> {
    use heartq_sampling_types::PriorTurnInterrupt;
    match category {
...
/// committing it would silently run heartq-build flavor. Distinct from
