...
//! window containing a [`heartq_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`heartq_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`heartq_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`heartq_mcp::servers::ClientStateKind::Empty`]
...
use heartq_mcp::servers::{McpClientEventKind, McpServerName};
