...
//! shell-specific types (`heartq_tools::MemoryBackend`, memory context).
//!
...
//! [`heartq_compaction::reminder`] so heartq-chat and heartq-build stay in lockstep.
...
use heartq_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[heartq_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[heartq_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn heartq_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[heartq_tools::implementations::skills::types::SkillInfo],
    memory_results: &[heartq_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        heartq_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use heartq_tools::implementations::search_tool::format_compaction_server_line;
