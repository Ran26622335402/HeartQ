...
//
// State is persisted to `~/.heartq/claude_import_state.json`.
...
use heartq_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.heartq/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::heartq_home::heartq_home().join("claude_import_state.json")
}
