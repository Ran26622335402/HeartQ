...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    async fn run_external_command(&self, command: &str) -> Option<HeartQAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: HeartQAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, HeartQAuth, HeartQComConfig};
