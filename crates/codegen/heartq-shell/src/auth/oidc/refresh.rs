...
use super::super::HeartQAuth;
use super::protocol::{OidcError, OidcUserInfo, build_heartq_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &HeartQAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_heartq_auth(tokens, user_info, issuer, client_id);
