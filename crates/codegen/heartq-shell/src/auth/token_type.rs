...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&HeartQAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> heartq_telemetry::events::AuthTokenKind {
        use heartq_telemetry::events::AuthTokenKind as K;
        match self {
