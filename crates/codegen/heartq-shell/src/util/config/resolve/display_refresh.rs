...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "HEARTQ_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "HEARTQ_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`HEARTQ_MIN_DRAW_MS` / `HEARTQ_SCROLL_CADENCE_MS`).
