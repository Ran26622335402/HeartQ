...
use heartq_shell::extensions::notification::{
    DiffContent, SessionNotification, SessionUpdate as XaiSessionUpdate,
};
use heartq_shell::session::info::Info as SessionInfo;
use heartq_shell::session::persistence::default_model_id;
use heartq_shell::session::storage::{JsonlStorageAdapter, SessionUpdate, StorageAdapter};
