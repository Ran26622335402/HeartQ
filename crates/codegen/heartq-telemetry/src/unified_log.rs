...
pub enum LogSource {
    ...
    #[serde(rename = "shell")]
    Shell,
    #[strum(serialize = "heartq-pager")]
    #[serde(rename = "heartq-pager")]
    HeartQPager,
    #[strum(serialize = "heartq-desktop")]
    #[serde(rename = "heartq-desktop")]
    HeartQDesktop,
}
...
fn log_path() -> PathBuf {
    heartq_home().join(LOG_DIR).join(LOG_FILE)
}
