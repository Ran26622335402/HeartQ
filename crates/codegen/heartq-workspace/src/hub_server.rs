...
use heartq_tools::implementations::heartq_build::scheduler::interval::interval_to_human;
use heartq_tools::implementations::heartq_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use heartq_tools::registry::types::FinalizedToolset;
use heartq_tools::types::resources::Terminal;
use heartq_workspace_types::rpc::workspace::{
...
static WORKSPACE_RPC_CALLER_MISMATCH_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "heartq_workspace_rpc_caller_mismatch_total",
...
static WORKSPACE_RPC_MUTATION_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "heartq_workspace_rpc_mutation_total",
...
static WORKSPACE_RPC_REQUESTS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "heartq_workspace_rpc_requests_total",
...
static WORKSPACE_RPC_DURATION_SECONDS: std::sync::LazyLock<HistogramVec> =
    std::sync::LazyLock::new(|| {
        register_histogram_vec!(
            "heartq_workspace_rpc_duration_seconds",
...
) -> Vec<heartq_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use heartq_tools::computer::types::TaskKind;
    use heartq_tools::types::resources::Terminal;
    use heartq_tools::types::tool::ToolKind;
    use heartq_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &heartq_tools::registry::types::FinalizedToolset,
) -> Vec<heartq_workspace_types::rpc::workspace::TodoSummaryWire> {
    use heartq_tools::implementations::heartq_build::todo::{TodoState, TodoStatus};
    use heartq_tools::types::resources::State;
    use heartq_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use heartq_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use heartq_workspace_types::rpc::search::FuzzyStatusReq;
        use heartq_workspace_types::rpc::skills::DiscoverPluginsReq;
        use heartq_workspace_types::rpc::workspace::{
        ...
        use heartq_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
...
mod tests {
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use heartq_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                ...
                Some(heartq_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn handle_call_records_rpc_metrics_and_collapses_unknown_method() {
        ...
        let has_bogus_series = prometheus::gather()
            .iter()
            .filter(|mf| mf.name() == "heartq_workspace_rpc_requests_total")
