...
// its wire types live in `heartq_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use heartq_workspace_types::rpc::fs::FsReadEncoding;
...
pub use heartq_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
