...
use heartq_mcp::rmcp;
use heartq_mcp::servers::{McpClient, parse_mcp_qualified_name};
...
/// Extract a server name from an [`McpError`](heartq_mcp::servers::McpError),
/// falling back to `"unknown"`.
pub(crate) fn server_name_from_mcp_error(e: &heartq_mcp::servers::McpError) -> &str {
