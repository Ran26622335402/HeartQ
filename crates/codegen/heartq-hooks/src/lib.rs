//! # heartq-hooks
//!
//! Runtime hook system for HeartQ — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for HeartQ. Hooks are discovered
//! from dedicated directories (`~/.heartq/hooks/` and `<git-worktree-root>/.heartq/hooks/`),
...
//!     Some(Path::new("/home/user/.heartq/hooks")),
//!     Some(Path::new("/project/.heartq/hooks")),
//! );
//!
//! for err in &errors {
