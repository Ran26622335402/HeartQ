use crate::{
    ...
    implementations::{
        codex, heartq_build, heartq_build_concise, heartq_build_hashline, opencode,
...
/// this crate: instead of `heartq-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::heartq_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::heartq_build::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::heartq_build::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::heartq_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::heartq_build::deploy_app::AppBuilderDeployerConfig,
...
impl ToolRegistryBuilder {
    ...
    /// Fully-qualified tool id (`"HeartQBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<heartq_build::BashTool, heartq_build::bash::BashParams>();
        b.register_with_params::<heartq_build::ReadFileTool, heartq_build::read_file::ReadFileParams>();
        b.register_with_params::<
                heartq_build::SearchReplaceTool,
                heartq_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<heartq_build::ListDirTool, heartq_build::list_dir::ListDirParams>();
        b.register_with_params::<heartq_build::GrepTool, heartq_build::grep::GrepParams>();
        b.register::<heartq_build::KillTaskTool>();
        b.register::<heartq_build::KillTerminalCommandTool>();
        b.register::<heartq_build::TodoWriteTool>();
        b.register::<heartq_build::UpdateGoalTool>();
        b.register::<heartq_build::WorkflowTool>();
        b.register::<heartq_build::TaskOutputTool>();
        b.register::<heartq_build::GetTerminalCommandOutputTool>();
        b.register::<heartq_build::WaitTasksTool>();
        b.register::<heartq_build::TaskTool>();
        b.register::<heartq_build::WebSearchTool>();
        b.register_with_params::<heartq_build::WebFetchTool, heartq_build::web_fetch::WebFetchParams>();
        b.register::<heartq_build::LspTool>();
        b.register::<heartq_build::ImageGenTool>();
        b.register::<heartq_build::ImageEditTool>();
        b.register::<heartq_build::ImageToVideoTool>();
        b.register::<heartq_build::ReferenceToVideoTool>();
        b.register::<heartq_build::EnterPlanModeTool>();
        b.register::<heartq_build::ExitPlanModeTool>();
        b.register_with_params::<
                heartq_build::AskUserQuestionTool,
                heartq_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<heartq_build::MonitorTool>();
        b.register::<heartq_build::SchedulerCreateTool>();
        b.register::<heartq_build::SchedulerDeleteTool>();
        b.register::<heartq_build::SchedulerListTool>();
        ...
        b.register::<crate::implementations::skill_manage::SkillManageImpl>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                heartq_build_concise::ReadFileConciseTool,
                heartq_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                heartq_build_concise::SearchReplaceConciseTool,
                heartq_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                heartq_build_concise::BashConciseTool,
                heartq_build::bash::BashParams,
            >();
        b.register_with_params::<
                heartq_build_hashline::HashlineReadTool,
                heartq_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                heartq_build_hashline::HashlineEditTool,
                heartq_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                heartq_build_hashline::HashlineGrepTool,
                heartq_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            ...
            let hashline_file_ids: &[&str] = &[
                "HeartQBuildHashline:hashline_read",
                "HeartQBuildHashline:hashline_edit",
                "HeartQBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if ctx.image_gen_config.has_credentials() {
            match crate::implementations::heartq_build::image_gen::ImageGenClient::new(
        ...
        if ctx.video_gen_config.is_enabled() {
            match crate::implementations::heartq_build::video_gen::VideoGenClient::new(
        ...
        if let crate::implementations::heartq_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::heartq_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::HeartQBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::heartq_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::heartq_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::heartq_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::heartq_build::scheduler::actor::SchedulerActor {
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "HeartQBuild:get_task_output" => {
            let has_heartq_build_bash = has_tool_with_bool_param(
                proposed,
                "HeartQBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_heartq_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "HeartQBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "HeartQBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "HeartQBuild", "run_terminal_cmd")
                && !has_heartq_build_bash
            {
                notes
                    .push(
                        "HeartQBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "HeartQBuildConcise", "run_terminal_cmd")
                && !has_heartq_build_concise_bash
            {
                notes
                    .push(
                        "HeartQBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (HeartQBuild:run_terminal_cmd or HeartQBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or HeartQBuild:task"
                .to_string();
            let has_provider = has_heartq_build_bash || has_heartq_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or HeartQBuild:task",
                )
                .with_category("requirements")
        }
        "HeartQBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as HeartQBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "HeartQBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires HeartQBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include HeartQBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "HeartQBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires HeartQBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include HeartQBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::heartq_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::heartq_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
                crate::implementations::heartq_build::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::heartq_build::deploy_app::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `heartq_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HeartQBuild:search_replace".to_string(),
                    params: Some(
                        serde_json::json!({
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HeartQBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full HeartQBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::heartq_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("HeartQBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (heartq).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let heartq = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("HeartQBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("HeartQBuild:get_task_output".to_string()),
                        ToolConfig::from_id("HeartQBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("heartq toolset should finalize");
        assert_eq!(
            heartq.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({ "id" : "HeartQBuild:read_file", "kind" : "read" }));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({ "id" : "HeartQBuild:read_file", "kind" : "raed" }));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({ "id" : "HeartQBuild:read_file" }));
    ...
    /// Verify HeartQBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HeartQBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "HeartQBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "HeartQBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<heartq_build::GrepTool>(),
                ToolConfig::for_tool::<heartq_build::KillTaskTool>(),
                ToolConfig::for_tool::<heartq_build::TaskOutputTool>(),
                ToolConfig {
                    id: "HeartQBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "HeartQBuild:run_terminal_cmd",
            "HeartQBuild:read_file",
            "HeartQBuild:search_replace",
            "HeartQBuild:list_dir",
            "HeartQBuild:grep",
            "HeartQBuild:get_terminal_command_output",
            "HeartQBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("HeartQBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("HeartQBuild:run_terminal_cmd", ToolKind::Execute),
            ("HeartQBuild:read_file", ToolKind::Read),
            ("HeartQBuild:search_replace", ToolKind::Edit),
            ("HeartQBuild:grep", ToolKind::Search),
            ("HeartQBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("HeartQBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `HeartQBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HeartQBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "HeartQBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HeartQBuildHashline:hashline_read".to_string(),
                params: Some(
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<heartq_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<heartq_build::ReadFileTool>(),
                ToolConfig::for_tool::<heartq_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "HeartQBuild:task"
                && e.message.contains("HeartQBuild:get_task_output")
                && e.message.contains("HeartQBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HeartQBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "HeartQBuild:task" && e.message.contains("HeartQBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HeartQBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// heartq-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("HeartQBuild:run_terminal_cmd"),
                tool("HeartQBuild:task"),
                tool("HeartQBuild:get_task_output"),
                tool("HeartQBuild:wait_tasks"),
                tool("HeartQBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("HeartQBuild:get_task_output"));
        assert!(error.message.contains("HeartQBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "HeartQBuild:task");
        assert!(error.message.contains("HeartQBuild:get_task_output"));
        assert!(error.message.contains("HeartQBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "HeartQBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "HeartQBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "HeartQBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default heartq-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("HeartQBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("HeartQBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("HeartQBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("HeartQBuildHashline:hashline_read"),
                hashline_tool_config("HeartQBuildHashline:hashline_edit"),
                hashline_tool_config("HeartQBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("HeartQBuild:read_file"),
                hashline_tool_config("HeartQBuild:search_replace"),
                hashline_tool_config("HeartQBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<heartq_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<heartq_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "HeartQBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<heartq_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<heartq_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<heartq_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "HeartQBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background" : true })
                    .as_object()
                    .unwrap()
    ...
    async fn heartq_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<heartq_build::ListDirTool>(),
                ToolConfig::for_tool::<heartq_build::ReadFileTool>(),
                ToolConfig::for_tool::<heartq_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<heartq_build::TaskOutputTool>(),
                ToolConfig::for_tool::<heartq_build::KillTaskTool>(),
                ToolConfig::for_tool::<heartq_build::GrepTool>(),
                ToolConfig::for_tool::<heartq_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = heartq_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = heartq_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<heartq_build::ListDirTool>()],
            behavior_preset: None,
        };
