...
use crate::implementations::heartq_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::heartq_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::heartq_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::heartq_build::grep::GrepSearchInput;
use crate::implementations::heartq_build::image_edit::ImageEditInput;
use crate::implementations::heartq_build::image_gen::ImageGenInput;
use crate::implementations::heartq_build::list_dir::ListDirInput;
use crate::implementations::heartq_build::read_file::ReadFileInput;
use crate::implementations::heartq_build::search_replace::SearchReplaceInput;
use crate::implementations::heartq_build::todo::TodoWriteInput;
use crate::implementations::heartq_build::update_goal::UpdateGoalInput;
use crate::implementations::heartq_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::heartq_build::web_fetch::WebFetchInput;
use crate::implementations::heartq_build::web_search::WebSearchInput;
...
use crate::implementations::skill_manage::SkillManageInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::heartq_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::heartq_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::heartq_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::heartq_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::heartq_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::heartq_build::workflow::WorkflowToolInput),
