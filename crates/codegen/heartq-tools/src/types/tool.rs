...
///
/// Serializes to snake_case (`heartq_build`, `mcp`, …) for the
...
/// (e.g. `"HeartQBuild:read_file"`); only the serde form goes on the wire.
#[derive(
    Debug,
    Clone,
    Copy,
...
pub enum ToolNamespace {
    #[serde(rename = "heartq_build", alias = "HeartQBuild")]
    HeartQBuild,
    #[serde(rename = "heartq_build_concise", alias = "HeartQBuildConcise")]
    HeartQBuildConcise,
    #[serde(rename = "heartq_build_hashline", alias = "HeartQBuildHashline")]
    HeartQBuildHashline,
    #[serde(alias = "Codex")]
    Codex,
