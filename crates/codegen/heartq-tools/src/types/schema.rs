...
///
/// Use with `#[schemars(with = "HeartQIntegerSchema")]` on `Option<usize>` fields.
pub struct HeartQIntegerSchema;
impl schemars::JsonSchema for HeartQIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "heartq_integer_schema".into()
    }
