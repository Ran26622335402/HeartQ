...
const XAI_VIDEO_BASE_MODEL: &str = "heartq-imagine-video";
const XAI_VIDEO_QUALITY_MODEL: &str = "heartq-imagine-video-1.5-preview";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "heartq-videos/";
...
pub struct VideoGenClient {
    ...
    /// and return the SuperHeartQ upsell prose. See [`VideoGenClient::is_tier_restricted`].
...
impl VideoGenClient {
    ...
    /// SuperHeartQ upsell instead of issuing a doomed request.
...
pub enum VideoGenConfig {
    ...
    Enabled {
        ...
        /// at call time with the SuperHeartQ upsell prose. Set by the host from
...
/// the deliberate `/imagine-video` slash command shows the SuperHeartQ upsell
/// modal instead.
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Video generation is a SuperHeartQ feature and isn't available on the free or X Basic tier. Let the user know they can unlock image and video generation by upgrading to SuperHeartQ: https://heartq.com/superheartq?referrer=heartq-build. Do not retry this tool.";
