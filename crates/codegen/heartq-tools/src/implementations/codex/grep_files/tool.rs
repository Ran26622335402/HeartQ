...
use crate::implementations::heartq_build::grep::ripgrep::rg_path;
...
///
/// Shares `ToolKind::Search` with the heartq-build `GrepTool`. These tools are
/// namespace-exclusive — consumers enable either `HeartQBuild` or `Codex` search,
