...
use crate::implementations::heartq_build::search_replace::CONTEXT_LINES;
use crate::implementations::heartq_build::search_replace::helpers::{
...
// the snake_case `params.edit.old_string` keys of the heartq_build twin resolve
...
// are imported from `heartq_build::search_replace::helpers` — shared across
// both the heartq_build and opencode edit tools.
